...
export default function EditUserModal({ isOpen, onClose, onSuccess, user }: EditUserModalProps) {
  ...
  // Update form when user or modal state changes
  useEffect(() => {
    if (isOpen) {
      setFormData({
        email: user.email,
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                Changing a user's role or status will affect their access immediately. Use the Deactivate button on the user list to temporarily disable access.
              </p>
            </div>
          </div>
        </div>
